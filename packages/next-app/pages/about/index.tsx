...
const Home = ({ calls }: { calls: CallForFunding[] }) => {
  ...
  return (
    <>
      <Head>
        <title>LOUDVΞRSΞ | Skill Marketplace, Crowdfunding, Gig Economy</title>
      ...
      <PageWrapper>
        ...
        <Box textAlign="center">
          ...
          <Box marginBottom="8" backgroundColor="backgroundSecondary">
            ...
            <Text size="extraLarge">
              <p>
                A winning project at <strong>ETH Denver 2022</strong> in both the <a href="https://dorahacks.io/buidl/2040">in-person</a>
                <br />
                and <a href="https://dorahacks.io/buidl/2434">virtual</a> hackathons, we launched a real-money, invite-only 
                <br />
                Beta round with 3k DAI from our winnings to keep learning and 
                <br />commission some awesome art — <a href="https://loudverse.xyz/calls">Check out these 6 creators!</a>
              </p>
            </Text>
            <Text size="extraLarge">
              <p>
          ...
          <Box marginBottom="8" backgroundColor="backgroundSecondary">
            <Text size="extraLarge">
              <p>
              <iframe width="560" height="315" src="https://www.youtube.com/embed/qY0-s_UsqKM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
              </p>
            </Text>
          </Box>
          {divider}
          ...
          <Box marginX="auto" marginBottom="16" backgroundColor="backgroundSecondary" maxWidth="screenLg">
            ...
            <Box display="flex" marginY="2" justifyContent="center" alignItems="center">
              ...
              <Box marginLeft="2">
                <Text size="extraLarge" align="left">
                  A Crowd-Commission is a non-transferrable NFT collectible that represents “proof of patronage” and 
                  can allow artists and contributors to co-create and share in the financial upside.
                </Text>
              </Box>
            </Box>
          </Box>
